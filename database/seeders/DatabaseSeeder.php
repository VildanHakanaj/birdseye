...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data->each(function ($movie) {
            Movie::create([
                "title" => $movie->title,
                "thumbnail_trending_small" => str_replace("./assets/", "images/", $movie->thumbnail->trending->small ?? null),
                "thumbnail_trending_large" => str_replace("./assets/", "images/", $movie->thumbnail->trending->large ?? null),
                "thumbnail_regular_small" => str_replace("./assets/", "images/", $movie->thumbnail->regular->small),
